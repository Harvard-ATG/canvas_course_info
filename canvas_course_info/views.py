...
from course_info.views import lti_launch as course_info_launch
...
def config(request: HttpRequest, registration_uuid: str) -> JsonResponse:
    ...
    placement settings for the Canvas Admin Console tool.
    ...
    description = "This LTI 1.3 tool allows instructors to view course info"
